...
\item Deployed centralized application and container/kubernetes pod logging using FluentD, Node_Exporter, Grok_Exporter and Prometheus to generate alerts for critical events and provide insight into infrastructure status
