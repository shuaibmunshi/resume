...
\section{Experience}
\runsubsection{2keys - Interac}
\descript{| Senior DevOps Specialist}

\location{February 2022 - Present | Ottawa, ON}
\vspace{\topsep}
\begin{tightitemize}
\item Developed Ansible playbooks/roles for deploying a next generation simulator platform on Digital Ocean and Nomad
\end{tightitemize}

\runsubsection{TELUS}
\descript{| Technology Specialist}

\location{June 2020 - February 2022 | Montreal, QC}
...
\descript{| DevOps Specialist Co-op}
...
\descript{\\| Cyber Systems Specialist Co-op}
